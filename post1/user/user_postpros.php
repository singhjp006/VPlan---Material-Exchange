...
if($type_photo=="image/jpg" || $type_photo=="image/jpeg" || $type_photo=="image/bmp" || $type_photo=="image/png")
	{
		if(move_uploaded_file($temp_photo,"../uploaded/".$name_photo))
					{
						$query_insert="INSERT INTO `post`.`userad` (`id`, `cat_id`, `ad_title`, `photo_name`, `description`, `price`, `contact_name`, `email`, `m_number`, `address`, `u_name`) VALUES (NULL, '$catId', '$ad_title', '$name_photo', '$description', '$price', '$contact_name', '$email', '$m_number', '$address','$user_id')";
